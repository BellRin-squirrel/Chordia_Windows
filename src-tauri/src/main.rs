...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // 30秒ごとに認証コードを更新するタスク (画面が開いている時だけ動作)
        ...
        .invoke_handler(tauri::generate_handler![
            cmd_window::open_new_window, cmd_window::set_mini_player_mode, cmd_window::close_mini_player, cmd_window::make_window_square, cmd_window::minimize_mini_player, cmd_window::show_in_explorer, // 修正：最小化コマンドを追加
            ...
            cmd_library::get_library_count, cmd_library::get_library_chunk, cmd_library::update_song_by_id, cmd_library::update_song_artwork_by_id, cmd_library::delete_song_by_id, cmd_library::get_common_values_for_selected, cmd_library::update_multiple_songs, cmd_library::delete_multiple_songs,
